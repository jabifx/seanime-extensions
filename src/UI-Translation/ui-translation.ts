function init() {
    $ui.register((ctx) => {
        ...
        released;lanzado;sorti;rilasciati;veröffentlicht;lançado;リリースされた;출시됨;发布
        ...
        Upload local lists to AniList;Subir listas locales a AniList;Téléverser les listes locales sur AniList;Carica liste locali su AniList;Lokale Listen zu AniList hochladen;Enviar listas locais para AniList;ローカルリストをAniListにアップロード;로컬 리스트를 AniList에 업로드;上传本地列表到AniList
        ...
        tray.render(() =>
            tray.stack({
                items: [
                    ...
                    tray.button("Aplicar", { onClick: "apply-language", intent: "success" }),
                ],
            })
        );
